...
$experience = [
    [
        'kind_of_activity' => 'Государственная служба',
        'start_date' => 2005,
        'expiration_date' => 2015,
        'description' => 'hhjdghhjdghhjdghhjghghj'
        
    ],
    [
        'kind_of_activity' => 'Логистика',
        'start_date' => 2015,
        'expiration_date' => 'По настоящее время',
        'description' => 'fhjfjyjtjrtytyjtyyjyj'
    ...
    <div class="w3-row-padding">
      ...
      <div class="w3-third">
        <div class="w3-white w3-text-grey w3-card-4">
          ...
          <div class="w3-container">
            ...
            <p><i class="fa fa-home fa-fw w3-margin-right w3-large w3-text-teal"></i>Город: <?php echo $city; ?></p>
      ...
      <div class="w3-twothird">
        <div class="w3-container w3-card w3-white w3-margin-bottom">
          ...
          <div class="w3-container">
            <h5 class="w3-opacity"><b><?php echo $experience[$i]['kind_of_activity'];?></b></h5>
            <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?php echo $experience[$i]['start_date'];?><span
                class="w3-tag w3-teal w3-round"><?php echo $experience[$i]['expiration_date'];?></span></h6>
